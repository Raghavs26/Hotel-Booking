  ...
  return (
    ...
    >
      <div className="container">
        <div className="row bs p-3 m-5" style={{ backgroundColor: "#F5F5DC" }}>
      ...
      <div className="row justify-content-center">
        {loading ? (
          ...
          hotels.map((room, i) => {
            return (
              <div className="col-md-8" data-aos="zoom-in" key={i}>
                <Room key={i} room={room} fromdate={fromdate} todate={todate} />
              </div>
            );
          })
        )}

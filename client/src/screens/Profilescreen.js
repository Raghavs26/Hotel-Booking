...
const { TabPane } = Tabs;
// https://thumbs.dreamstime.com/z/hotel-reception-bell-modern-luxury-counter-desk-44648471.jpg
          ...
          <div className="row ml-sm-1">
            ...
            >
              ...
              <div className="text-right">
                {user.isAdmin ? (
                  <>
                    <Link to="/admin" className="btn btn-primary mr-3">
                      Go To Admin Page
                    </Link>
